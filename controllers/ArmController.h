...
public:
    ...
    METHOD_LIST_BEGIN
        ...
        ADD_METHOD_TO(ArmController::handlePlan,       "/plan",      drogon::Post);
        ADD_METHOD_TO(ArmController::handlePlanPMP,    "/plan_pmp",  drogon::Post);
        ADD_METHOD_TO(ArmController::handleMPCiLQR4,   "/mpc_ilqr4", drogon::Post);
    METHOD_LIST_END
